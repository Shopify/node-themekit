...
our [Code of Conduct](https://github.com/Shopify/node-themekit/blob/master/CODE_OF_CONDUCT.md).
...
```
git clone git@github.com:your-username/node-themekit.git
```
...
## Examples
See [here](https://github.com/Shopify/node-themekit/blob/master/examples) for our examples.
